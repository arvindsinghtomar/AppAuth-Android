...
class IdentityProvider {
    ...
    public static final IdentityProvider EXAMPLE_PROVIDER = new IdentityProvider(
            "OpenID",
    ...
    public static final List<IdentityProvider> PROVIDERS = Arrays.asList(EXAMPLE_PROVIDER);
